...
class DDPG_IL(object):
    ...
    def learn(self):
        ...
        # 对于模仿学习，前期需要拟合专家策略将self.IL_Lambda1设置大点，后前探索学习将self.IL_Lambda1设置小点
        loss_a = - torch.mean(self.Critic_Net_eval(sample_memory_s, a_s) - self.IL_Lambda1 * self.loss1(a_s, sample_memory_a))
        self.loss_a.append(self.loss1(a_s, sample_memory_a).item())
